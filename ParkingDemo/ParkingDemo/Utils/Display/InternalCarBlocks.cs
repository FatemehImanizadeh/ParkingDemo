...
namespace ParkingDemo.Utils
{
    internal static class InternalCarBlocks
    {
        ...
        private static Dictionary<int, Curve[]> Load()
        {
            ...
            using (var stream = typeof(InternalCarBlocks).Assembly.GetManifestResourceStream("ParkingDemo.Cars.3dm"))
        ...
        {
            string name = "ParkingDemo_Cars_" + parking.CarsPerCell + "_v1_" + doc.ModelUnitSystem;
