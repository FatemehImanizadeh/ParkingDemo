                ...
                for (int i = 0; i < PathFirst.cells.Count; i++)
                {
                    ...
                    { //برای این که سلولهایی که حیلی از هم فاصله دارن رو انتخاب نکنه
                        ...
                        if (manhatanDis < 4)//
                        {
                            ...
                            var lotgain = PathConnection.LotGain(PathFirst.cells[i], PathSecond.cells[j], mtx, true, out bool isPossible);
                            ...
                            var lotgain2 =PathConnection.LotGain(PathFirst.cells[i], PathSecond.cells[j], mtx, false, out bool isPossible2);
                    ...
                    if (pathFirst.cells != null && pathSecond.cells != null)
                    {
                        if (pathFirst.cells.Count > 0 && pathSecond.cells.Count > 0)
                        {
                            ...
                            /* int lotGain = 1;
                             ...
                             //    bool isPossible ; 
                                 lotGain = 
                                 ParkingUtils.PathConnection.LotGain(cellRan1, cellRan2, mtx, true, out bool isPossible);*/
